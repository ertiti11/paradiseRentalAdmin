...
export const metadata: Metadata = {
  title: "Next.js Profile | ParadiseRentalAdmin - Next.js Dashboard Template",
  description:
    "This is Next.js Profile page for ParadiseRentalAdmin - Next.js Tailwind CSS Admin Dashboard Template",
};
        ...
        <div className="overflow-hidden rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
          ...
          <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
            ...
            <div className="mt-4">
              ...
              <p className="font-medium">Tanque</p>
